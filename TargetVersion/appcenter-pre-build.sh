...
/Library/Frameworks/Mono.framework/Versions/6_4_0/bin/msbuild /Users/runner/work/1/s/TargetVersion/TargetVersion.csproj /t:PackageForAndroid -t:SignAndroidPackage -p:AndroidPackageFormat=aab /p:Configuration=Release -v:diag
